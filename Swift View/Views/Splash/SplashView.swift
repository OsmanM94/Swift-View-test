    ...
    var body: some View {
        ZStack {
            ...
            SpikeCircle()
                ...
                .animation(Animation.linear(duration: 10).repeatForever(autoreverses: false), value: isRotated )
            Circle()
                .fill(Color.gray)
            ...
            SpikeCircle()
                ...
                .animation(Animation.linear(duration: 25).repeatForever(autoreverses: false), value: isRotated )
                .overlay {
                    Circle()
...
class SpikeCircleView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        replicatorInstanceLayer.fillColor = UIColor.gray.cgColor
        replicatorInstanceLayer.strokeColor = UIColor.gray.cgColor
